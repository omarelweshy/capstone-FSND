...
class SchoolTestCase(unittest.TestCase):
    ...
    def test_get_teachers_200(self):
        req = self.client().get('/teachers', headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)

    def test_get_students_200(self):
        req = self.client().get('/students', headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)
    ...
    def test_post_teachers_200(self):
        ...
        req = self.client().post('/teachers', json=teacher, headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)
    ...
    def test_post_students_200(self):
        ...
        req = self.client().post('/students', json=student, headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)
    ...
    def test_delete_teachers_200(self):
        req = self.client().delete('/teachers/5', headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)

    def test_delete_students_200(self):
        req = self.client().delete('/students/7', headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)

    def test_delete_teachers_401(self):
        req = self.client().delete('/teachers/10000', headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 401)

    def test_delete_students_401(self):
        req = self.client().delete('/students/10000', headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 401)
    ...
    def test_patch_teachers_200(self):
        ...
        req = self.client().patch('/teachers/4', json=teacher, headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)
    ...
    def test_patch_students_200(self):
        ...
        req = self.client().patch('/students/11', json=student, headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 200)
    ...
    def test_patch_teachers_401(self):
        ...
        req = self.client().patch('/teachers/11', json=teacher, headers={'Authorization': 'Bearer '+self.token})
        data = json.loads(req.data)
        self.assertEqual(req.status_code, 401)
